...
class TextEmbedder:
    ...
    def embed_documents_to_list(self, docs: Union[str, List[str]], normalize: bool = True):
        return self.embed_documents(docs, normalize=normalize).tolist()

    def embed_queries_to_list(self, queries: Union[str, List[str]], normalize: bool = True):
